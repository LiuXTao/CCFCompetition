...
alter_ALTERNO_info = pd.merge(alter_ALTERNO_info_sum,alter[['ALTAF_ALTBE','ALTBE','ALTAF','EID']],on=['EID']).drop_duplicates(['EID'])
...
x_valid_1 = tmp1.sample(frac=0.3, random_state=40, axis=0)
x_train_1 = tmp1.drop(x_valid_1.index.tolist())
x_valid_2 = tmp0.sample(frac=0.1, random_state=40, axis=0)
